...
| `references/directions.md` | Phase 2 — the direction catalog, each entry with a ready-made token line. **Assemble from it; do not derive palettes by hand** — that is the largest avoidable cost in a run |
